...
export default function ButtonContainer({ handleCalculationChange, handleChange, handleClearInput, handlePositiveNegative, handleResult }) {
    return (
        <div id='btn-container'>
            <Row id='basic-calculator-row-1' className='basic-calculator-row'>
                ...
                <Button id='percentage-btn' label='%' onClick={() => handleCalculationChange('%')}/>
            ...
            <Row id='basic-calculator-row-4' className='basic-calculator-row'>
                ...
                <Button id='num-three-btn' label='3' onClick={() => handleChange('4')}/>
            ...
            <Row id='basic-calculator-row-5' className='basic-calculator-row'>
                ...
                <Button id='period-btn' label='.' onClick={() => handleCalculationChange('.')}/>

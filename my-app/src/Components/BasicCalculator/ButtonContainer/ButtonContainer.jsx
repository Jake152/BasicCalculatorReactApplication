...
export default function ButtonContainer({ handleChange, handleClearInput, handlePositiveNegative }) {
    return (
        <div id='btn-container'>
            <Row id='basic-calculator-row-1' className='basic-calculator-row'>
                <Button id='clear-all-btn' label='Clear' onClick={() => handleClearInput(0)}/>
                <Button id='postive-negative-btn' label='+/-' onClick={() => handlePositiveNegative()}/>
                <Button id='percentage-btn' label='%' onClick={() => handleChange('%')}/>
                <Button id='divide-btn' label='/' onClick={() => handleChange('/')}/>
            </Row>
            <Row id='basic-calculator-row-2' className='basic-calculator-row'>
                ...
                <Button id='multiplication-btn' label='X' onClick={() => handleChange('X')}/>
            </Row>
            <Row id='basic-calculator-row-3' className='basic-calculator-row'>
                ...
                <Button id='subtraction-btn' label='-' onClick={() => handleChange('-')}/>
            </Row>
            <Row id='basic-calculator-row-4' className='basic-calculator-row'>
                ...
                <Button id='addition-btn' label='+' onClick={() => handleChange('+')}/>
            </Row>
            <Row id='basic-calculator-row-5' className='basic-calculator-row'>
                ...
                <Button id='equals-btn' label='=' onClick={() => handleChange('=')}/>
            </Row>
        </div>
    )
}